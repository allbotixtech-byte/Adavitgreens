export const navLinks = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    href: "/services",
    children: [
      { label: "E-Waste Recycling & Management", href: "/services/e-waste" },
      { label: "Plastic Waste Management", href: "/services/plastic-waste" },
      { label: "Extended Producer Responsibility (EPR)", href: "/services/epr" },
      { label: "Secure Data Destruction", href: "/services/data-destruction" },
      { label: "Battery & Solar Panel Recycling", href: "/services/battery-recycling" },
      { label: "Reverse Logistics & Asset Buyback", href: "/services/reverse-logistics" },
      { label: "Sustainability Consulting & ESG Reporting", href: "/services/sustainability" },
    ],
  },

...
- Networking and telecom equipment (routers, switches, PBX)
- UPS systems and power supplies
- Monitors, printers, scanners and peripherals
- Cables, connectors and wiring harness
- Printed circuit boards (PCBs)
- Consumer electronics (televisions, audio systems, appliances)
...
**Key Benefits:**
- GPCB Plastic Waste Management authorisation
- Batch-wise quality testing of recycled granules
- EPR certificate generation for brand owners
...
## 3. Extended Producer Responsibility (EPR) Services
...
- Plastic Waste EPR (Plastic Waste Management Rules, 2016)
- Battery Waste EPR (Battery Waste Management Rules, 2022)
- CPCB portal registration and onboarding
- Annual target computation and fulfilment planning
- Certificate of Recycling and EPR credit generation
- Quarterly and annual compliance filings
- Audit documentation and regulatory liaison

**Key Benefits:**
- CPCB registered recycler and processor
- Single point of contact for multi-stream EPR (e-waste + plastic + battery)
- Audit-ready documentation with traceable manifests
...
- USB drives, memory cards and removable media
- Photocopier and printer hard disks
...
**Key Benefits:**
- Certificate of Data Destruction with serial-level tracking
- Chain-of-custody documentation from pickup to processing
- On-site destruction option for sensitive environments
...
**Tagline:** Clean Energy Deserves a Clean End-of-Life.
...
**What We Handle:**
- Lithium-ion battery packs and cells (from EVs, laptops, power tools, UPS)
- Lead-acid batteries (industrial, automotive, inverter)
- Nickel-cadmium and nickel-metal hydride batteries
- End-of-life solar photovoltaic modules (crystalline and thin-film)
- Solar inverters and associated electronic components
- Energy storage system components

**Key Benefits:**
- Authorised handling under Battery Waste Management Rules, 2022
- Dedicated discharge area to eliminate fire and chemical hazards
- Downstream channelling to CPCB-authorised smelters
- Material recovery of lithium, cobalt, nickel, lead, silver and copper
...
- Manifest-based chain-of-custody transport
- Asset inventorying and condition grading
- Fair-market valuation with transparent recovery basis
- Buyback payment against accepted offer
- Data sanitisation before resale or recycling
- Certificate of Recycling for non-reusable assets
...
## 7. Sustainability Consulting & ESG Reporting

**Tagline:** Measure What Matters. Report What's Real.
...
**What We Cover:**
- Waste stream audit and baseline assessment
- Circular economy strategy development
- Carbon footprint estimation from waste diversion metrics
- BRSR (Business Responsibility and Sustainability Reporting) data preparation
- CSR project design and impact documentation
- Sustainability policy drafting and review
- Employee and stakeholder awareness programmes
- Annual sustainability report preparation

**Key Benefits:**
- Reports grounded in verified processing data from our facility
- Aligned with SEBI BRSR, GRI Standards and SDG frameworks
- Helps meet investor, client and regulatory ESG expectations
...
| 6 | Logistics | Reverse Logistics & Asset Buyback | Managed collection, valuation and buyback of retired IT and electronic assets. |
| 7 | ESG | Sustainability Consulting & ESG Reporting | Audit-ready sustainability data grounded in verified recycling outcomes. |

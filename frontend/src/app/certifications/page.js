      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <motion.div
            ...
            className="w-full max-w-3xl mx-auto bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/80 shadow-card"
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-100">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-50 hover:bg-slate-100 text-xs font-semibold text-secondary-700 border border-slate-200 transition-colors cursor-pointer"
              >
            ...
            <div className="grid sm:grid-cols-2 gap-3.5 py-6 text-sm">
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                <span className="text-xs text-slate-400 uppercase tracking-wide block mb-1">Legal Company Name</span>
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                <span className="text-xs text-slate-400 uppercase tracking-wide block mb-1">Constitution</span>
                <span className="font-semibold text-secondary-950">Private Limited Company</span>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                <span className="text-xs text-slate-400 uppercase tracking-wide block mb-1">Effective Date</span>
              ...
              <div className="sm:col-span-2 p-3.5 rounded-xl bg-slate-50 border border-slate-100">
                <span className="text-xs text-slate-400 uppercase tracking-wide block mb-1">Facility Address</span>

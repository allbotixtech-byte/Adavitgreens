...
export default function IndustryCard({ icon: Icon, title, description, index = 0 }) {
  return (
    <motion.div
      ...
      className="group bg-white rounded-2xl p-7 border border-industrial-200/80 text-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-card-hover hover:border-primary-300 flex flex-col items-center"
    >

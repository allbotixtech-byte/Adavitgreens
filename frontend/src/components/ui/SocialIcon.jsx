 ...
 *
 * lucide-react dropped its brand icons in v1, so these are inline SVG paths
 * (24x24, filled) kept local to avoid another icon dependency. Colour comes
 * from `currentColor`, so callers set the theme colour on the wrapper.
 *
 * Keys match `companyInfo.social` in src/data/navigation.js — add a path here
 * when a new network is added there.
 */
...
const PATHS = {
  ...
  instagram:
    ...
    "4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-" +
    "3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 " +
  ...
  // X, still keyed as `twitter` to match the data file
  twitter:
  ...
  youtube:
    "M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 " +
    "0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 " +
    "002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 " +
    "002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z",
};
...
export function hasSocialIcon(name) {
